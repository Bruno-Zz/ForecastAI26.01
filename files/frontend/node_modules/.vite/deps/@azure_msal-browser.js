...
var StandardController = class _StandardController {
  ...
  async handleRedirectPromiseInternal(options) {
    ...
    const useNative = platformBrokerRequest && this.platformAuthProvider && !(options == null ? void 0 : options.hash);
    let rootMeasurement;
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-YKMN4HEB.js");
    }
  } catch (e) {
  }
  return void 0;
