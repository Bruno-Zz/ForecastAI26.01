...
function le(t2, e2) {
  const n2 = t2.action ? t2.action.bind(e2.tour) : null, o2 = !!t2.disabled && re(t2.disabled, e2), i2 = t2.label ? re(t2.label, e2) : null, r2 = t2.text ? re(t2.text, e2) : null, l2 = ne("button", s({}, t2.attrs || {}, { "aria-label": i2 || null, class: `${t2.classes || ""} shepherd-button ${t2.secondary ? "shepherd-button-secondary" : ""}`, disabled: o2 || null, onclick: n2, tabindex: "0", type: "button" }));
...
function ce(t2, n2) {
  ...
  return n2.options.title && o2.append(function(t3, n3) {
    ...
    return ne("button", s({}, t3.attrs || {}, { "aria-label": t3.label ? t3.label : "Close Tour", class: "shepherd-cancel-icon", onclick: (t4) => {
